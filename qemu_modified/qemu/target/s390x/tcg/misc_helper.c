...
uint32_t HELPER(stsi)(CPUS390XState *env, uint64_t a0, uint64_t r0, uint64_t r1)
{
    ...
    case STSI_R0_FC_LEVEL_1:
        if ((sel1 == 1) && (sel2 == 1)) {
            ...
            //ebcdic_put(sysib.sysib_111.manuf, "XETA            ", 16);
            ...
            //ebcdic_put(sysib.sysib_111.model, "XETA            ", 16);
            //ebcdic_put(sysib.sysib_111.sequence, "XETA            ", 16);
    ...
    case STSI_R0_FC_LEVEL_2:
        if ((sel1 == 2) && (sel2 == 1)) {
            ...
            //ebcdic_put(sysib.sysib_222.name, "XETA    ", 8);
